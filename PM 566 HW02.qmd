...
col_bins    <- c("#f7fbff", "#6baed6", "#08306b")          # low→mid→high for heatmaps
...
```
## Reports: Based on the plots above, in summation, hgiher pressure, higher humidity, higher precipitation, higher wind speed, and lower visibility showed the relatively strongest associations with larger delays.